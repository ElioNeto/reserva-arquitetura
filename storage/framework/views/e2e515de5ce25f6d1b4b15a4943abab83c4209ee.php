            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo e(url('/Cliente/form')); ?>">Criar reserva</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo e(url('/Quarto')); ?>">Listar</a></li>
                            <li><a href="<?php echo e(url('/Quarto/cadastro')); ?>">Cadastrar Quarto</a></li>
                        </ul>
                    </li>
                </ul>
